...
const Header = () => {
  ...
  return (
    <header className="fixed w-full top-0 md:p-4 bg-secondary border-b border-b-my-brown">
      <div className="relative max-w-7xl mx-auto p-4 md:p-0">
        <div className="flex justify-between items-center ">
          ...
          >
            ...
            <div className="flex md:justify-center border-t md:border-none pt-4 md:pt-0">
